...
const uploadedImageUrl = ref(
    props.order.orderPattern.patternMedia || "/images/photo.png"
);
...
const sendPostByBot = () => {
    axios
        .post(route("order.send-pattern-by-bot"), {
            pattern: props.order.orderPattern,
        })
        ...
        <main>
            <div class="top">
                <div class="header">
                    ...
                    <div
                        class="flex flex-col items-start justify-center gap-y-6 sm:items-center mb-8"
                    >
                        <h1
                            class="sm:text-center text-start text-violet-100 sm:text-3xl text-xl font-bold font-['Open Sans'] leading-10 sm:text-lg text-base"
                        >
                            Посмотреть задание
                        </h1>
                    </div>
                    ...
                    <div>
                        <div class="flex justify-between py-4">
                            ...
                            >
                                Срок публикации:
                                <span
                                    class="text-opacity-60 text-sm font-normal font-['Open Sans'] leading-tight"
                        ...
                        <div
                            class="flex justify-between border-y-2 border-violet-100 border-opacity-40 py-4"
                        >
                            <p
                                class="text-violet-100 text-sm font-normal font-['Open Sans'] leading-tight"
                            >
                        ...
                        <template v-for="list in listOfLinks">
                            <div class="py-4">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div
                                        class="text-violet-100 text-sm font-bold py-1 px-2 rounded-lg bg-slate-700 font-['Open Sans'] leading-tight"
                                    >
                                        {{ list.text }}
                                    </div>
                                </div>
                        ...
                        <div class="px-4 sm:p-0">
                            <div class="mt-6 w-full before">
                                <div class="before_container">
                                    <n-image-group
                                        v-if="
                                            order.orderPattern.patternMedia
                                                .length
                                        "
                                    >
                                        <transition-group
                                        ...
                                        >
                                            <div
                                                v-for="(image, index) in order
                                                    .orderPattern.patternMedia"
                                                :key="'img-' + index"
                                                class="bg-center bg-cover w-full"
                                            >
                                                <img
                                                    class="cursor-pointer w-full object-fill"
                                                    @click.prevent="
                                    ...
                                    <div
                                        ...
                                        v-html="order.orderPattern.body"
                                    ></div>
                                </div>
                            </div>
                        </div>
                        <button
                            @click.prevent="sendPostByBot"
                            class="py-2 my-2 rounded-3xl w-full btn_gradient-purple transition hover:bg-purple-800 text-violet-100 text-base font-bold font-['Open Sans'] leading-snug"
                        >
