...
const sendReview = () => {
    axios
        .post(route("review-send"), {
            review_text: reviewMessage.value,
                ...
                <div class="w-3/4 mx-auto">
                    <div class="w-1/2 mx-auto">
                        ...
                        <button
                            ...
                            class="py-2 w-full mt-6 btn_gradient-purple rounded-3xl text-violet-100 text-lg font-bold font-['Open Sans'] leading-normal"
                        >
                            Отправить
                        </button>
                    </div>
