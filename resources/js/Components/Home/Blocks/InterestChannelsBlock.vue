<template>
    <div class="bg_fon interestChannels interestChannels_mid">
        <div class="w-full">
            <div class="container mx-auto">
                <div
                    class="interestChannels__header sm:mt-0 lg:mb-24 mb-10 px-4"
                >
                    <h1
                ...
                <div class="interestChannels__categories">
                    <div class="lg:flex px-2 justify-between hidden gap-2">
                        <div class="flex flex-col gap-6 self-start">
                            ...
                            >
                                Все каналы в нашем каталоге отсортированы <br />
                                по категориям, вот некоторые из них
                            </div>
                            <div>
                                <div
                    ...
                    <div class="block justify-between lg:hidden">
                        <div class="flex flex-col gap-6">
                            ...
                            >
                                Все каналы в нашем каталоге отсортированы по
                                категориям, вот некоторые из них
                            </div>
                        </div>
