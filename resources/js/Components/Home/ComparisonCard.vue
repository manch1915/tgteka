...
<template>
    <div class="samo">
        ...
        <h3 class="text-violet-100 text-3xl font-bold font-['Open Sans'] leading-10">{{ props.item.header }}</h3>
        <ul class="text-violet-100 text-lg font-normal font-['Open Sans'] leading-loose gap-4">
