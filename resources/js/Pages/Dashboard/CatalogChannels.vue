                ...
                <div class="additional_filter">
                    ...
                    <n-space vertical size="large" class="mt-6">
                        ...
                        <div>
                            ...
                            <n-input
                                ...
                                :allow-input="allowOnlyNumbers"
                                v-model:value="
                                    channelStore.additionalFilter.err_percent
                                "
                            />
                        </div>
                        <div>
                            ...
                            <n-input
                                ...
                                :allow-input="allowOnlyNumbers"
                                v-model:value="
                                    channelStore.additionalFilter.er_percent
                                "
                            />
                        </div>
                        <div>
                            ...
                            <n-input
                                ...
                                :allow-input="allowOnlyNumbers"
                                v-model:value="
                                    channelStore.additionalFilter.daily_reach
                                "
                            />
                        </div>
                        <div>
                            ...
                            <n-input
                                ...
                                :allow-input="allowOnlyNumbers"
                                v-model:value="
                                    channelStore.additionalFilter.ci_index
                                "
                            />
                        </div>
                        <div>
                            ...
                            <n-input
                                ...
                                :allow-input="allowOnlyNumbers"
                                v-model:value="
                                    channelStore.additionalFilter.mentions_count
                                "
                            />
                        </div>
                        <div>
                            ...
                            <n-input
                                ...
                                :allow-input="allowOnlyNumbers"
                                v-model:value="
                                    channelStore.additionalFilter.forwards_count
                                "
                            />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <n-input
                                ...
                                :allow-input="allowOnlyNumbers"
                                v-model:value="
                                    channelStore.additionalFilter.posts_count
                                "
                            />
                        </div>
                    </n-space>
                    <n-space
                        v-if="channelStore.additionalFilter.peerType === 'chat'"
                        vertical
                        size="large"
                        class="mt-6"
                    >
                        ...
                        <div>
                            ...
                            <n-input
                                ...
                                :allow-input="allowOnlyNumbers"
                                v-model:value="
                                    channelStore.additionalFilter.dau
                                "
                            />
                        </div>
                        <div>
                            ...
                            <n-input
                                ...
                                :allow-input="allowOnlyNumbers"
                                v-model:value="
                                    channelStore.additionalFilter.wau
                                "
                            />
                        </div>
                        <div>
                            ...
                            <n-input
                                ...
                                :allow-input="allowOnlyNumbers"
                                v-model:value="
                                    channelStore.additionalFilter.mau
                                "
                            />
                        </div>
                        <div>
                    ...
                    <div class="flex justify-center">
                        <button
                            ...
                            class="text-violet-100 text-xs font-normal font-['Open Sans'] underline leading-none"
                        >
                            Очистить форму
                        </button>
                    </div>
            ...
            <div class="w-full pr-0 filter sm:pr-10">
                ...
                <transition>
                    <div v-show="additionalFilter" class="additional_filter">
                        ...
                        <n-space
                            v-if="
                                channelStore.additionalFilter.peerType ===
                                'chat'
                            "
                            vertical
                            size="large"
