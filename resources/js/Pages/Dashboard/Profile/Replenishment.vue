...
const createPaymentRequest = () => {
    ...
    axios
        .post(route("create-payment-request"), { amount: initialValue.value })
        .then((response) => {
            if (response.data) {
                ...
                >
                    <n-tab-pane name="oasis">
                        <template #tab>
                            <button
                                @click.prevent="
                                    activeButton = 'add-payment-method'
                                "
                                :class="[
                                    'tab-button',
                                    'transition',
                        ...
                        <div class="px-4 pb-12 org">
                            <div class="inline-block org_commission">
                                <div class="flex items-start">
                                    ...
                                    >
                                        Комиссия системы на ввод составляет
                                        15%<br />
                                        Минимальная сумма пополнения 20000 р.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="mt-12 sm:w-2/4">
                                ...
                                <n-input
                                    class="my-1 py-1.5"
                                    :theme-overrides="inputThemeOverrides"
                                    placeholder="Физический адрес (для почтовой корреспонденции)"
                                />
                                <n-input
                                    class="my-1 py-1.5"
                                    :theme-overrides="inputThemeOverrides"
                            ...
                            <div class="attention">
                                <div class="flex items-start">
                                    ...
                                    <p
                                        class="text-violet-100 text-base font-normal font-['Open Sans'] leading-tight"
                                    >
                                        Обратите внимание! Компания не является
                                        плательщиком НДС. Средства будут
                                        зачислены на баланс в течение 1 - 3
                                        банковских дней после оплаты.Работаем с
                                        ЭДО. Счет выставляется на основании
